  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empowering Your Business with HR Management Application: Streamlining Human Resources for Increased Efficiency and Productivity"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empowering Your Business with HR Management Application: Streamlining Human Resources for Increased Efficiency and Productivity`}
            </Text>
            <Box
